...
%description -l cs
Balíèek obsahuje autentizaèní modul pro WWW server Apache, který
...
%description -l ja
¤³¤Î¥Ñ¥Ã¥±¡¼¥¸¤Ë¤Ï Apache Web ¥µ¡¼¥Ð¡¼¤Ç LDAP ¥Ç¥£¥ì¥¯¥È¥êÆâ¤Î¥æ¡¼¥¶¡¼
...
%description -l ru
üÔÏ ÍÏÄÕÌØ ÁÕÔÅÎÔÉÆÉËÁÃÉÉ ÄÌÑ Apache, ÐÏÚ×ÏÌÑÀÝÉÊ ÉÄÅÎÔÉÆÉÃÉÒÏ×ÁÔØ
HTTP-ËÌÉÅÎÔÏ× ÎÁ ÏÓÎÏ×Å ÚÁÐÉÓÅÊ ÐÏÌØÚÏ×ÁÔÅÌÑ × ËÁÔÁÌÏÇÅ LDAP.
...
%description -l zh_CN
ÕâÊÇÓÃÓÚ Apache µÄÑéÖ¤Ä£¿é£¬ËüÔÊÐíÄúÊ¹ÓÃ LDAP Ä¿Â¼ÖÐµÄÓÃ»§ÏîÑéÖ¤ HTTP
¿Í»§»ú¡£
